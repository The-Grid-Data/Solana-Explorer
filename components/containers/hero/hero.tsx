  ...
  return (
    <section className="container mx-auto flex max-w-4xl flex-col items-center gap-2 py-8 md:py-12 md:pb-8 lg:py-12 lg:pb-12">
      ...
      <p className="max-w-xl text-center text-lg font-light text-foreground">
        Browse Solana&apos;s ecosystem via <a href="https://thegrid.id">The Grid&apos;s</a> data.<br></br> Filter to find what matters to you or intergrate this data into your own product using the API.
      </p>
    </section>
  );
};
